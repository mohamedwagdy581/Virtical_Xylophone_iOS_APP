...
#ifndef XYLOPHONEAPP_SWIFT_H
#define XYLOPHONEAPP_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="XylophoneApp",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC12XylophoneApp11AppDelegate")
...
SWIFT_CLASS("_TtC12XylophoneApp13SceneDelegate")
...
SWIFT_CLASS("_TtC12XylophoneApp14ViewController")
@interface ViewController : UIViewController
- (void)viewDidLoad;
- (IBAction)notePressed:(UIButton * _Nonnull)sender;
